...
import { exportPDF } from '../../rapport/exportPDF'
          ...
          {filtered.map((r) => (
            <div key={r.id} className="bg-white rounded-2xl shadow-lg p-4 flex items-center gap-4">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={() => exportPDF(r)} className="p-2 text-gray-500 hover:text-green-600 hover:bg-green-50 rounded-lg transition-all" title="PDF">
